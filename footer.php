            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="https://twitter.com/example" target="_blank" rel="noopener noreferrer" class="text-neutral-400 hover:text-white transition-colors">
                            <span class="sr-only">Twitter</span>
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path></svg>
                        </a>
                        <a href="https://instagram.com/example" target="_blank" rel="noopener noreferrer" class="text-neutral-400 hover:text-white transition-colors">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <a href="privacy-policy.php" class="block text-neutral-400 hover:text-white transition-colors">Privacy Policy</a>
                        <a href="cookie-policy.php" class="block text-neutral-400 hover:text-white transition-colors">Cookie Policy</a>
                    </div>
                </div>
            </div>
            <div class="mt-8 pt-8 border-t border-neutral-800">
                <p class="text-center text-neutral-400">&copy; 2024 FoodFusion. All rights reserved.</p>
            </div>
        </div>
    </footer>
